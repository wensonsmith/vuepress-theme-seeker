<template>
    <Framework>
        <BackButton/>
        <h1> <span v-text="currentKey"></span><span class="divider">/</span> <span class="count" v-text="count"></span></h1>
        <br/>
        <PostList></PostList>
...
export default {
    computed: {
        currentKey() {
            return this.$currentCategories ? this.$currentCategories.key : this.$currentTags.key
        },
        count() {
